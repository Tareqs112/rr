/**
 * تهيئة قاعدة البيانات وإنشاء بيانات الاختبار
 * يستخدم هذا الملف لإنشاء جداول قاعدة البيانات وإضافة بيانات الاختبار قبل تنفيذ الاختبارات
 */
...
const setupTestEnvironment = async () => {
  try {
    console.log('بدء تهيئة بيئة الاختبار...');
    ...
    const model1 = await VehicleModel.create({
      ...
      fuel_type: 'petrol',
      daily_rate: 200.00,
      image_url: 'https://example.com/images/camry.jpg'
    });
    ...
    const model2 = await VehicleModel.create({
      ...
      fuel_type: 'petrol',
      daily_rate: 500.00,
      image_url: 'https://example.com/images/landcruiser.jpg'
    });
    ...
    const model3 = await VehicleModel.create({
      ...
      fuel_type: 'petrol',
      daily_rate: 180.00,
      image_url: 'https://example.com/images/sonata.jpg'
    });
    ...
    console.error('حدث خطأ أثناء تهيئة بيئة الاختبار:', error);
    return false;
  }
};
...
if (require.main === module) {
  setupTestEnvironment()
    .then(result => {
      console.log(`نتيجة تهيئة بيئة الاختبار: ${result ? 'ناجحة' : 'فاشلة'}`);
